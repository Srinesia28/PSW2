<head>
  ...
  <br><br><br><br><br>
    ...
    <center>
        <h2><img src="img/logo.jpeg" width="80px" alt="">&nbsp;&nbsp;<b class="title" style="color: navy;">MSA Laptop</b></b></h2>
    ...
    @csrf
        ...
        <label for=""><i class="fas fa-key" id="password"></i> Password</label>
        <input class="form-control" type="text" name="password" id="password"><br><br>
        <p class="btn btn" href = "">Registrasi</p>
        <button class="btn btn-primary" style="margin-top: -2px;" type="submit" >Login</button>       
    </form>
